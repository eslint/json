...
**Important:** This plugin requires ESLint v9.15.0 or higher and you must be using the [new configuration system](https://eslint.org/docs/latest/use/configure/configuration-files). Type compatibility is guaranteed with ESLint v9.39.0 or greater.
