...
ruleTester.run("sort-keys", rule, {
	...
	invalid: [
		...
		{
			code: '/* leading comment */ {"b":1,"a":2}',
			output: '/* leading comment */ {"a":2,"b":1}',
			language: "json/jsonc",
			errors: [
				{
					messageId: "sortKeys",
		...
		// desc, insensitive
		{
			...
			output: '{"b":3, "a":1, "_":2} // desc, insensitive',
			language: "json/jsonc",
			options: ["desc", { caseSensitive: false }],
			errors: [
				{
		...
		// desc, natural
		{
			...
			output: '{"b":3, "a":1, "_":2} // desc, natural',
			language: "json/jsonc",
			options: ["desc", { natural: true }],
			errors: [
				{
		...
		// desc, natural, insensitive
		{
			...
			output: '{"b":3, "a":1, "_":2} // desc, natural, insensitive',
			language: "json/jsonc",
			options: ["desc", { natural: true, caseSensitive: false }],
			errors: [
				{
		...
		{
			code: '{"b":1,"a":{"y":1,/*comment*/"x":1}}',
			output: '{"a":{"y":1,/*comment*/"x":1},"b":1}',
			language: "json/jsonc",
			errors: [
				{
					messageId: "sortKeys",
		...
		{
			code: '{"b":{"y":1,"x":1},/*comment*/"a":2}',
			output: '{"b":{"x":1,"y":1},/*comment*/"a":2}',
			language: "json/jsonc",
			errors: [
				{
					messageId: "sortKeys",
